    ...
    watch: {
      ...
      compass: {
        files: [
            ...
            '<%= yeoman.app %>/styles/partials/{,*/}*.scss'
        ],
    ...
    filerev: {
      dist: {
        src: [
          ...
          /**
           * comment out to ensure real paths for scss image mapping
           */
...
/**/
  ...
  grunt.registerTask('default', [
    ...
    /* REGISTER HEROKU BUILD CONTROL */
    grunt.registerTask('heroku', function (target) {
        grunt.log.info( 'target::', target );
