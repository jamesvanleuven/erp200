DROP FUNCTION IF EXISTS public.cs_select_customers(
	_location integer
	, _param1 text
	, _param2 text
);
...
DECLARE 
	...
	BEGIN
		...
		sql := 'SELECT array_to_json(array_agg(row_to_json(t)))'
			...
			|| ', a.customer_type_id, a.customer_abbr, a.license_number, a.address, a.city, a.zipcode, a.opens, a.closes'
...
SELECT * FROM cs_select_customers(1,'kel',NULL);