DROP FUNCTION IF EXISTS public.rtn_report_orders(
    integer
    , integer
    , integer[]
    , integer[]
...
CREATE OR REPLACE FUNCTION public.rtn_report_orders(
	_limit integer
	, _offset integer
	, _locations integer[]
...
SELECT * FROM rtn_report_orders(1, 0, ARRAY[1,2,3], ARRAY[362], ' AND (a.created >= ''2017-06-01 00:00:00'' AND a.created <= ''2017-06-30 23:59:59'') ');